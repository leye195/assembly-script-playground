...
import { gaussianBlur } from "../libs/utils";
  ...
  const handleBlur = useCallback(
    (e: SyntheticEvent<HTMLImageElement>) => {
      ...
      img.addEventListener("load", () => {
        ...
        const blurData = gaussianBlur(width, height, uint8ArrayData, 20, 5);
